...
# TODO: 
def finding_patterns(input_file, output_path):
    ...
    all_results = [
        '{}model1_start_stop.csv'.format(output_path),
        '{}model2_start_stop.csv'.format(output_path),
        '{}model3_start_stop.csv'.format(output_path)]
    model1_variant_results = [
        '{}m1_variant_pos1.csv'.format(output_path),
        '{}m1_variant_pos2.csv'.format(output_path),
        '{}m1_variant_pos3.csv'.format(output_path),
        '{}m1_variant_pos4.csv'.format(output_path),
        '{}m1_variant_pos5.csv'.format(output_path),
        '{}m1_variant_pos6.csv'.format(output_path)]
